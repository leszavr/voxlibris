...
**Полное руководство:** см. [Ручное применение миграций БД на production](./migrations-manual.md)
...
**Для первоначального развёртывания (greenfield)** на чистую БД смотрите раздел "Greenfield развёртывание" в [миграциях-manual.md](./migrations-manual.md#-greenfield-развёртывание-чистая-бд).
