...
- **[Руководство развертывания](./deployment-guide.md)** - базовые процессы и конфигурация
- **[Ручное применение миграций](./migrations-manual.md)** ⭐ **КРИТИЧЕСКИ ВАЖНО** - пошаговая инструкция для ops по применению БД миграций на production
- **[Docker развертывание](./docker.md)** - контейнеризация и Docker Compose
- **[Мониторинг](./monitoring.md)** - наблюдение за production
- **[Подготовка окружения](./environment-setup.md)** - переменные и конфигурация
