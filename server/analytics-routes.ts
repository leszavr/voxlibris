...
import analyticsDetailsRouter from './routes/analytics/details.js';
import mobilePwaAnalyticsRouter from './routes/analytics/mobile-pwa.js';
...
router.use('/', mobilePwaAnalyticsRouter);
 ...
 */
router.use('/', analyticsDetailsRouter);
