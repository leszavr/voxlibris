import { ClubRepositoryBase, buildTagsMap, matchesCatalogSearch, normalizeCatalogClubType, parseReaderJoinRequestsEnabled } from './club-repository-helpers.js';
 ...
 */
export class ClubRepository extends ClubRepositoryBase {
