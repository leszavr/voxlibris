...
export default function Library() {
  ...
  const handleUpdateBook = async () => {
    ...
    try {
      ...
      console.error("Failed to update book:", error instanceof Error ? error.message : error);
      toast({
        title: "Ошибка",
  ...
  const handleDeleteBook = async () => {
    ...
    try {
      ...
      console.error("Failed to delete book:", error instanceof Error ? error.message : error);
      toast({
        title: "Ошибка",
